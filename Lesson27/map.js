...
console.log('Ex. 1');
console.log(wordsExercise1.map((word) => word.toUpperCase()));
...
console.log('Ex. 2');
console.log(numbersExercise2.map((num) => num * num));
...
console.log('Ex 5:');
const namesGrades = studentsExercise5.map(
  (student) => `${student.name} ${student.grade}`,
);
console.log(namesGrades);
